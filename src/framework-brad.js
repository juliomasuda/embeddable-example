...
window.Framework = {
    config: {
        ...
        clientIds: {
            ...
            'mypurecloud.com.au': '',
            'mypurecloud.jp': '',
            'apps.sae1.pure.cloud': 'ccc376af-3830-4c2b-b398-99da336fd5d9'
        },
        customInteractionAttributes: ['Agencia', 'Conta'],
        settings: {
