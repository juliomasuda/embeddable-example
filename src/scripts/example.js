document.addEventListener('DOMContentLoaded',function(){
	...
	document.getElementById('sendContactSearch').addEventListener("click", sendContactSearch);
    ...
    function userLogout() {
        console.log('process User Logout');
		
		window.location.href = "https://login.mypurecloud.com/logout?client_id=4bb5f6ff-1a28-4ee7-8582-c223fe1088e5&redirect_uri=https://localhost/example.html";
		//window.location.replace("https://login.mypurecloud.com/logout?client_id=4bb5f6ff-1a28-4ee7-8582-c223fe1088e5&redirect_uri=https://localhost/example.html");
    }
